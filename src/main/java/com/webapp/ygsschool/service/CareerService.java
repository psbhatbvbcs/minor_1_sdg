...
public class CareerService {
    ...
    public boolean saveJobDetails(Career career, MultipartFile multipartFile, RedirectAttributes redirectAttributes) {
        ...
        if (savedJob != null && savedJob.getJobId() > 0) {
            isSaved = true;
            redirectAttributes.addFlashAttribute("jobMessage", "You have successfully applied for job at Campus Compass. We will get back to you within 24 hrs.");
        }
    ...
    public boolean rejectCandidate(int jobId) {
        ...
        // Sending email
        String subject = "Campus Compass Job Application";
        String body = "Dear " + career.get().getFirstName() + ", \n\nThank you for applying for the position of Professor at Campus Compass.\nWe regret to inform you that we are unable to consider your candidature further. \nWe wish you all the best for your future endeavors. \n\nRegards,\nCampus Compass, Hubli";
    ...
    public boolean hireCandidate(int jobId) {
        ...
        // Sending Email
        String subject = "Campus Compass | Interview Invitation";
        String body = "Dear " + career.get().getFirstName() + ", \n\nCongratulations! Your application for the Professor position stood out to us and we would like to invite you for an interview at our Campus Compass. \nYour interview has been scheduled on " + career.get().getDatetime().toLocalDate() + " at 1:30 PM. \n\nRegards,\nCampus Compass, Hubli";
        emailSenderService.sendEmail(career.get().getEmail(), subject, body);
